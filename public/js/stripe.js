$(document).ready(function() {
    ...
    form.addEventListener('submit', function(event) {
        ...
        var options = {
            ...
            address_line1: document.getElementById('street_address1').value,
            address_line2: document.getElementById('street_address2').value,
            ...
            address_tel: document.getElementById('phone_number').value
